...
static inline uint32_t get_delta_time_in_us(TEE_Time start, TEE_Time stop)
{
		...
		uint32_t *spent_time_in_us)
{
	...
	*spent_time_in_us = get_delta_time_in_us(start_time, stop_time);
		...
		uint32_t param_types, TEE_Param params[4])
{
	...
	uint32_t *spent_time_in_us = &params[2].value.a;
